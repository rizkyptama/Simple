                    ...
                    <tbody>
                        <tr>
                            <td class="padded">
                                ...
                                <h1>Verifikasi Akun SIMPEL</h1>
                                <p>Selamat, akun <strong><?= $subject;?></strong> berhasil terverifikasi.</p>
                                <p>Sekarang akun anda sudah aktif untuk digunakan diwebsite Simpel.</p>

                                <p style="text-align:center;color: #333;" class="strong">
                                    Nama Anda : <u><b><?= $nama;?></b></u><br>
                                    Alamat Anda : <u><b><?= $alamat;?></b></u>
                                </p>
                                <center><a href="http://simpel.depok.go.id/login" class="btn" target="_blank" style="text-align:center;color: #fff;">Login Disini</a></center>
                            </td>
                        </tr>
                    </tbody>
                </table>
